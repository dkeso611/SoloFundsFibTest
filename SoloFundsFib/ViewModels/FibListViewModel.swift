...
class FibListViewModel: ListViewModelProtocol {
    ...
    var displayList: [RowView] {
        list.map {
            RowView(id: $0.id, leadingTitle: $0.inputString, trailingTitle: $0.computedNumberString)
        }
        .reversed()
    }

    var detailViewList: [RowView] {
        list.map {
            RowView(id: $0.id,leadingTitle: $0.inputString, trailingTitle: $0.elapsedTimeString)
        }
        .reversed()
    }
